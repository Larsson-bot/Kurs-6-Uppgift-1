    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           ).AddJwtBearer(jwt =>
           {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Kurs_6_Uppgift_1", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Kurs_6_Uppgift_1 v1"));
            }
